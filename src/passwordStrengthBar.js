...
var PasswordStrengthBar = PasswordStrengthBar_1 = (function () {
    ...
    PasswordStrengthBar.prototype.getStrengthIndexAndColor = function (password) {
        return this.getColor(PasswordStrengthBar_1.measureStrength(password));
    };
    ...
    PasswordStrengthBar.prototype.setBarColors = function (count, col, text) {
